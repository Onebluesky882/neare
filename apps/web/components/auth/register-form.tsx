    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <Link href="/" style={{ fontWeight: 700, fontSize: 18, letterSpacing: '-0.02em', color: 'var(--text)', textDecoration: 'none', display: 'block', marginBottom: 28 }}>
            YourApp
          </Link>
          <h1 style={{ fontSize: 24, fontWeight: 700, letterSpacing: '-0.03em', marginBottom: 8 }}>Create your account</h1>
          <p style={{ fontSize: 14, color: 'var(--text-muted)' }}>Start building your software company</p>
        </div>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, padding: '28px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              <label style={{ display: 'block', fontSize: 13, fontWeight: 500, color: 'var(--text-muted)', marginBottom: 6 }}>Your name</label>
              <input
                type="text"
